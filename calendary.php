            ...
            <div class="sticky-top mb-3">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Tus eventos</h4>
                </div>
                <div class="card-body">
                <!-- the events -->
                <div id="external-events">
                  <div class="external-event bg-success">Realizar curso</div>
                  <div class="external-event bg-warning">Asistir a conferencia</div>
                  <div class="external-event bg-info">Almorzar</div>
                  <div class="external-event bg-primary">Trabajar en proyecto</div>
                  <div class="external-event bg-danger">Breake</div>
                  <div class="checkbox">
                    <label for="drop-remove">
                      <input type="checkbox" id="drop-remove">
                      Remover o eliminar evento
                    </label>
                  </div>
                </div>
              </div>
