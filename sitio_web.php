...
<head>
    ...
    <title>ExprOut | Portafolio</title>
...
<div class="contenedor">
		...
		<section class="grid" id="grid">
			...
			<div class="item"
				 ...
				 data-descripcion="2.- El mundo informático."
			>
				<div class="item-contenido">
			...
			<div class="item"
				 ...
				 data-descripcion="3.- Alimentación balanciada y vital."
			>
				<div class="item-contenido">
			...
			<div class="item"
				 ...
				 data-descripcion="4.- La fuerza de voluntad rompe barreras."
			>
				<div class="item-contenido">
			...
			<div class="item"
				 ...
				 data-descripcion="5.- La salud mental es escencial en la naturaleza del ser humano."
			>
				<div class="item-contenido">
			...
			<div class="item"
				 ...
				 data-descripcion="6.- Cuida tu elemento más poderoso,la mente."
			>
				<div class="item-contenido">
			...
			<div class="item"
				 ...
				 data-descripcion="7.- La belleza de la naturaleza es incomparable."
			>
				<div class="item-contenido">
			...
			<div class="item" 
				 ...
				 data-descripcion="8.- Avance con la tecnología."
			>
				<div class="item-contenido">
			...
			<div class="item"
				 ...
				 data-descripcion="9.- La vitalidad del deporte.
				 	"
			>
				<div class="item-contenido">
